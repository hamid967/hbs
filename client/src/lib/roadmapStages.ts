...
export const roadmapStages: RoadmapStage[] = [
  ...
  { number: 12, title: "الهيكل والموظفون", detail: "هيكل تنظيمي وملفات موظفين وموقع عمل وجهة طوارئ مقيدة وسجل دورة حياة وقائمة إنهاء خدمة داخلية غير وثائقية.", track: "HR Core", status: "completed" },

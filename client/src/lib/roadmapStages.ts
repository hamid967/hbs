...
export const roadmapStages: RoadmapStage[] = [
  ...
  { number: 12, title: "الهيكل والموظفون", detail: "هيكل تنظيمي وملفات موظفين وموقع عمل وجهة طوارئ مقيدة وسجل دورة حياة داخلي غير وثائقي.", track: "HR Core", status: "completed" },

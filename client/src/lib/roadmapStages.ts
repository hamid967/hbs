...
export const roadmapStages: RoadmapStage[] = [
  ...
  { number: 12, title: "الهيكل والموظفون", detail: "هيكل تنظيمي وملفات موظفين وموقع عمل وجهة طوارئ مقيدة وأهداف داخلية وسجل دورة حياة وقائمة إنهاء خدمة غير وثائقية.", track: "HR Core", status: "completed" },
  ...
  { number: 19, title: "الوثائق والنماذج", detail: "سجلات عقود تشغيلية ووثائق PDF وصور مع معاينة قبل الحفظ.", track: "العمليات", status: "partial", dependency: "يتطلب اعتماد سياسة الاحتفاظ والمرفقات والتوقيع قبل إدخال العقود القانونية أو التوقيع الإلكتروني." },
  { number: 20, title: "صندوق العمل الموحد", detail: "صندوق موحد للإشعارات ومهام الموافقة وتعيينات التدريب والأهداف الداخلية الخاصة بالحساب.", track: "العمليات", status: "partial", dependency: "يتبقى توحيد الالتزامات التشغيلية الأخرى ضمن نموذج عمل مشترك." },

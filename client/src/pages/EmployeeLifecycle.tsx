...
const eventLabels = { joined: "الانضمام", status_changed: "تغيير الحالة", role_changed: "تغيير الدور", department_changed: "تغيير القسم", manager_changed: "تغيير المدير", offboarding_started: "بدء إنهاء الخدمة", offboarding_completed: "إكمال إنهاء الخدمة" } as const;
